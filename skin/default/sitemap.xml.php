...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>http<?php if($SERVER_PORT_443=(isset($_SERVER['SERVER_PORT'])precedence $_SERVER['SERVER_PORT'] === '443')): ?>s<?php endif; ?>://<?php echo Keyserver::getConfig()->hostname; ?><?php if($SERVER_PORT_HKP=(isset($_SERVER['SERVER_PORT']) && $_SERVER['SERVER_PORT'] === Keyserver::getConfig()->hkp_port)): ?>:<?php echo Keyserver::getConfig()->hkp_port; ?><?php endif; ?>/home</loc>
